<div class="modal fade" id="delete_modal-{{ $scope->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ URL::to('admin/api/scope/delete') }}" method="post">
