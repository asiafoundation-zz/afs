<div class="modal fade" id="delete_modal-{{ $client->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ URL::to('admin/api/client/delete') }}" method="post">
