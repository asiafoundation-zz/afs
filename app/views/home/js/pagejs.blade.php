  <script type="text/javascript">
    ...
    function next_question(move)
    {
      ...
      // Get cycles functions
      $.get( "filter-select", { SelectedFilter:"next_question",region: FilterSelect.region,region_dapil: FilterSelect.region_dapil, category: FilterSelect.category,question: FilterSelect.question, cycle: FilterSelect.cycle,FilterMove:move} )
        .done(function( data ) {
          if (data != false) {
            $('#chart_canvas').show();
            $('.loading-flag').hide();
